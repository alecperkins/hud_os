...
def loadAll():
    ...
    data['subway_realtime'] = _loadCacheable('subway_realtime', fetchNYCSubwayRealTime, max_age_s=int(60 * 0.75))
    data['subway_status'] = _loadCacheable('subway_status', fetchNYCSubwayStatus, max_age_s=int(60 * 5))
    data['citibike'] = _loadCacheable('citibike', fetchCitibike, max_age_s=int(60 * 0.75))
