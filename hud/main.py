...
data = {
    'line1': randint(0,100000),
    'line2': randint(0,100000),
}
...
# display.init()
# display.show(display.getbuffer(Bimage), display.getbuffer(Rimage))
# display.sleep()
...
# font24 = ImageFont.truetype(os.path.join(picdir, 'Font.ttc'), 24)
# draw_black.text((10, 0), 'Hello, world! ' + str(randint(0,10000)), font = font24, fill = 0)
# draw_red.text((10, 30), 'Hello, world?', font = font24, fill = 0)


# display.init()
# display.display(display.getbuffer(Bimage), display.getbuffer(Rimage))
# display.sleep()
